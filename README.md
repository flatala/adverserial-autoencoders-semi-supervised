...
- The python implemntation of the adversarial autoencoder can be found here: **[aae.py](aae.py)**
- A jupyer notebook with example usage: **[experiments.ipynb](experiments.ipynb)**
